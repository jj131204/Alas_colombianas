  ...
  <div>
    ...
    <section class = "all">
        ...
        <section  class="secc_especies">
          ...
          <h2 class="title_especies">Todas nuestras Aves</h2>
...
INNER JOIN habitats ha ON ha.ha_id=sp.ha_id ") as $row){ // aca puedes hacer la consulta e iterarla con each.  
    ...
    <div class = "border">
      <div  class = "all_final">
        ...
        <div class = "desciption_final">
          ...
          <div class = "names_title"> Nombre científico </div>
          ...
          <div class = "names_title"> Género </div>
