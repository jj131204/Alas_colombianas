  ...
  <div>
    ...
    <section class = "all">
        ...
        <section  class="secc_especies">
          ...
          <h2 class="title_especies"> Especies presentes en esta habitat</h2>
...
INNER JOIN habitats ha ON ha.ha_id=sp.ha_id  WHERE  sp.ha_id = $id_ave ") as $row){ // aca puedes hacer la consulta e iterarla con each. ?> 
